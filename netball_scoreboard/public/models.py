...
class Match(models.Model):
    ...
    quarter_duration = models.PositiveIntegerField(default=15) # in minutes
    timer_status = models.CharField(max_length=10, choices=TIMER_STATUS_CHOICES, default='stopped')
    quarter_end_time = models.DateTimeField(null=True, blank=True)
    remaining_time_on_pause = models.DurationField(null=True, blank=True)
